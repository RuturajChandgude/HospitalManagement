...
export class AddEditNurseDialogComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, private nurseService: NurseService, private dialogRef: MatDialogRef<AddEditNurseDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: UpdateNurse) { }
