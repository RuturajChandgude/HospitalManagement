...
constructor(private fb:FormBuilder,private PhysicianService:PhysicianService,private dialogRef:MatDialogRef<EditPhysicianComponent>,@Inject(MAT_DIALOG_DATA) public data:GetPhysician){}
...
ngOnInit() {
    ...
    this.physicianForm=this.fb.group({
      physicianId:[this.data?this.data.physicianId:'',Validators.required],
